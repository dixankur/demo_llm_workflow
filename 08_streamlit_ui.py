...
add_selectbox = st.sidebar.selectbox(
    "Workflow:",
    ("Transcript", "Datasets", "Data Dictionary")
)
...
sel_question = st.selectbox(
    'Select your question from existing questions ...',
    (questions)
)
